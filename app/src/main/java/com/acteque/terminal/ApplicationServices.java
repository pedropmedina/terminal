...
public final class ApplicationServices implements AutoCloseable {
  ...
  public static ApplicationServices create(Function<String, String> configuration) {
    return new ApplicationServices(
      configuration,
      List.of(new TiingoProviderFactory()),
      List.of(new ElbstreamProviderFactory())
    );
  }
